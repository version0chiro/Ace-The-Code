<h2>1460. Make Two Arrays Equal by Reversing Sub-arrays</h2><h3>Easy</h3><hr><div><p>Given two integer arrays of equal length <code>target</code> and <code>arr</code>.</p>
