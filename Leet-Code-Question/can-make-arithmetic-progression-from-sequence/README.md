<h2>1502. Can Make Arithmetic Progression From Sequence</h2><h3>Easy</h3><hr><div><p>A sequence of numbers is called an <strong>arithmetic progression</strong> if the difference between any two consecutive elements is the same.</p>
