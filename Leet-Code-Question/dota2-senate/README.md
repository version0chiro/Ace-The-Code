<h2>649. Dota2 Senate</h2><h3>Medium</h3><hr><div><p>In the world of Dota2, there are two parties: the Radiant and the Dire.</p>
...
<pre style="position: relative;"><strong>Input:</strong> senate = "RD"
...
<pre style="position: relative;"><strong>Input:</strong> senate = "RDD"
