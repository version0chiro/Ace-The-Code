<h2>1191. K-Concatenation Maximum Sum</h2><h3>Medium</h3><hr><div><p>Given an integer array <code>arr</code> and an integer <code>k</code>, modify the array by repeating it <code>k</code> times.</p>
